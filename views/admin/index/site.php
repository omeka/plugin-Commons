...
<form enctype="multipart/form-data" action="" method="post">    
    ...
    <label for='admin_email'>Email address</label>
        <div class='inputs'>
            <?php echo $this->formText('admin_email', get_option('commons_site_admin_email'), array('size'=>'20')); ?>
    ...
    <label for='admin_name'>Name</label>
        <div class='inputs'>
            <?php echo $this->formText('admin_name', get_option('commons_site_admin_name'), array('size'=>'20')); ?>
    ...
    <label for='admin_username'>Username</label>
        <div class='inputs'>
            <?php echo $this->formText('admin_username', get_option('commons_site_admin_username'), array('size'=>'20')); ?>
    ...
    <label for='affiliation'>Affiliation</label>
        <div class='inputs'>
            <?php echo $this->formText('affiliation', get_option('commons_site_admin_affiliation'), array('size'=>'42')); ?>
    ...
    <label for='content_summary'>Content summary</label>
        <div class='inputs'>
            <?php echo $this->formTextarea('content_summary', get_option('commons_site_content_summary'), array('rows'=>10)); ?>
    ...
    <label for='join_reason'>Reason for contributing</label>
        <div class='inputs'>
            <?php echo $this->formTextarea('join_reason', get_option('commons_site_reason'), array('rows'=>10)); ?>
    ...
    <input id="submit" class="submit" type="submit" value="Update" name="submit" />
    <?php else:?>
